...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        win_x = win_width
        win_y = int(win_height-win_height/2)
        print("Window X:", win_x)
        print("Window Y:", win_y)
        win_geometry = f'{win_width}x{win_height}+{win_x}+{win_y}'
        print("Window Geometry:", win_geometry)
