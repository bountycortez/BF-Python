...
SESSION_VERIFY = True  # False ... ignore SSl-Certificate Errors
...
if __name__ == "__main__":
    ...
    xmlmessage = etree.CDATA("""
            <ie:EM815 xmlns:ie="http://brz.gv.at/zo/emcs/v30/em815/ie" xmlns:tms="http://brz.gv.at/zo/emcs/v30/tms" xmlns:com="http://brz.gv.at/zo/emcs/v30/com">
              <ie:Header>
                ...
                <tms:MessageIdentifier>message-0001d</tms:MessageIdentifier>
                <!--Optional:-->
    ...
    if responseMessage:
        ...
        print(f"RESPONSE.message for sendMessage(): None")
    print("--------------------------------------------------------------------")

    if responseContentType == 1:
        print('RESPONSE CONTENTTYPE 1 MEANS RESPONSE IS A MESSAGE!')
        ...
        print('RESPONSE CONTENTTYPE 3 MEANS ACK!')
    elif responseContentType == 4:
        print('RESPONSE CONTENTTYPE 4 MEANS NO MESSAGES!')
    elif responseContentType == 5:
        print('RESPONSE CONTENTTYPE 5 MEANS LAST MESSAGE!')
    else:
